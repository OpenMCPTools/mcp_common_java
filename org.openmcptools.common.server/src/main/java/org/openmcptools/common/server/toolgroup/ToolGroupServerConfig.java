...
public class ToolGroupServerConfig<TransportType> {
	...
	public static final String TOOL_GROUP_SERVER_CONFIG = ToolGroupServerConfig.class.getName() + ".toolGroupServerConfig";
	
	public static final String DEFAULT_SERVER_NAME = System.getProperty(ToolGroupServerConfig.class.getName() + ".defaultServerName", "Default MCP Server Name");
	public static final String DEFAULT_SERVER_VERSION = System.getProperty(ToolGroupServerConfig.class.getName() + ".defaultServerVersion", "0.0.1");
	public static final Long DEFAULT_SERVER_REQUEST_TIMEOUT = Long.parseLong(System.getProperty(ToolGroupServerConfig.class.getName() + ".defaultServerRequestTimeout", "10"));
	...
	public ToolGroupServerConfig(String serverName, String serverVersion, TransportType transport,
	...
	public ToolGroupServerConfig(String serverName, String serverVersion, TransportType transport) {
		this(DEFAULT_SERVER_NAME, DEFAULT_SERVER_VERSION, transport, DEFAULT_SERVER_REQUEST_TIMEOUT, null);
	}
